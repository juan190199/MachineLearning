...
def threshold_classifier(type, X=None, threshold=None, error=False):
    ...
    :param X: array-like of shape (n, )
        Numpy array with test set to be classified
    ...
    :return:
        If error is false, array-like of shape (n, ) -- Predictions for test set.
...
def nn_classifier(training_set, test_set):
    ...
    :param training_set: array-like of shape (n, k)
        Training set of n instances and k labels

    :param test_set: array-like of shape (n, k)
        Test set of n instances and k labels

    :return: array-like of shape (test_set.shape[0], )
        Prediction following nearest neighbor rule
    """
